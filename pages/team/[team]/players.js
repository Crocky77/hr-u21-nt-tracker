...
const COLUMN_DEFS = [
  ...
  { key: "nationality", label: "Nation", compactLabel: "Nat" },
...
export default function TeamPlayersPage() {
  ...
  // options for position dropdown (from data)
  ...
  const filteredPlayers = useMemo(() => {
    ...
    return players.filter((p) => {
      ...
      if (sp !== "all" && specVal && specVal !== sp) return false;
    ...
    <Layout>
        ...
        <div className="main">
          ...
          <div className="filters portalLine">
            ...
            <select className="inp" value={specialty} onChange={(e) => setSpecialty(e.target.value)}>
              <option value="all">Speciality (all)</option>
      ...
      <style jsx>{`
        ...
        .main {
          flex: 1 1 auto;
          min-width: 0;
          /* give maximum width to table area */
        }
